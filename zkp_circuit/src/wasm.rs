...
#[wasm_bindgen]
pub fn wasm_test(major_code: u128, signature_r: u128, signature_s: u128, msg: u128) -> JsValue {
    let k = 4;
    let params: Params<EqAffine> = Params::new(k);
    ...
    let circuit = MyCircuit {
        ...
        // [2] ed25519 signature check
        signature_r: Value::known(Fp::from_u128(signature_r)),
        signature_s: Value::known(Fp::from_u128(signature_s)),
        message: Value::known(Fp::from_u128(msg)),
    };
